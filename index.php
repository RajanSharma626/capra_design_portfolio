...
<body>
    ...
    <!--Home Section Start-->
    <section id="home" class="banner" style="background-image: url('images/background/yatch2.jpg')"
            ...
            <div class="banner-caption">
                ...
                <p class="cd-headline clip ">
                    ...
                    <span class="cd-words-wrapper">
                        <!-- <b >Creating Designer.</b>  -->
                        <b class="is-visible">Designing Yacht.</b>
                    </span>
                </p>
            </div>
                ...
                <div class="col-lg-7 col-md-6">
                    ...
                    <div class="about-content">
                        ...
                        <p> At the moment I provide service as detailed drawings for shipyard, or Direct Clients.
                            ...
                            I'm able to transfert the expérience for residential luxury project, where space need to be
                            optimize and the quality of details are very high.</p>
                        <p>
                            I'm also open to new opportunities and due to the past years of collaboration with other
                            people
                            I'm able to make a team that can cover impegnati e project.
                            I love sailing and the sea in general and I'm based in Monaco.
                        </p>
                        <!--About Social Icons-->
    ...
    <!--Stats Section Start-->
    <section class="stats pt-100 pb-100" style="background-image: url('images/background/yacht3.jpg')">
        <div class="container">
